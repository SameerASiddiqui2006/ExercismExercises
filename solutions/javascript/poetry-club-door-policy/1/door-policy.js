...
export function backDoorResponse(line) {
  let lastLetter = line.trim();
  return lastLetter.at(-1);
}
...
export function backDoorPassword(word) {
  let password_back = word.toLowerCase();
  password_back = password_back[0].toUpperCase() + password_back.slice(1) + ", please";
